...
export const Education: React.FC = () => {
  return (
    <section id="education" className="py-16 sm:py-20 relative bg-slate-950/60">
          ...
          {EDUCATION_LIST.map((edu: EducationType) => (
            ...
            >
              <div className="space-y-4">
                ...
                {/* Institution & Program */}
                <div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-100 group-hover:text-cyan-300 transition-colors flex items-center gap-2">
                    {edu.type === 'Bootcamp' ? (
                ...
                {/* Description */}
                {edu.description && (
                  <p className="text-slate-400 text-xs sm:text-sm leading-relaxed pt-2 border-t border-slate-800/80">
                    {edu.description}
                  </p>
                )}
              </div>
