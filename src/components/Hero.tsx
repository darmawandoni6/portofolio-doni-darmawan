      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-5 sm:space-y-6">
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/30 text-cyan-300 text-xs sm:text-sm font-medium shadow-inner max-w-full">
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg sm:text-2xl font-semibold text-slate-300 flex items-center gap-2 flex-wrap">
                Software Engineer
                <span className="text-slate-600 hidden sm:inline">•</span>
                <span className="text-cyan-400 font-mono text-base sm:text-lg">
            ...
            {/* Location & Quick Meta */}
            <div className="flex flex-wrap gap-2.5 sm:gap-4 text-xs sm:text-sm text-slate-400 pt-1 w-full sm:w-auto">
              ...
              <a
                ...
                className="flex items-center gap-1.5 bg-slate-900/60 px-3 py-1.5 rounded-lg border border-slate-800 hover:text-cyan-400 hover:border-cyan-500/30 transition-all truncate"
              >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2 w-full">
              ...
              <a
                href="#npm-packages"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/80 font-semibold text-sm text-slate-200 hover:text-cyan-300 transition-all duration-200 group"
              >
                <Package className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 group-hover:rotate-12 transition-transform" />
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end mt-4 lg:mt-0">
            <div className="relative group w-full max-w-[280px] xs:max-w-[320px] sm:max-w-md">
              ...
              {/* Card Wrapper */}
              <div className="relative rounded-3xl bg-slate-900/90 p-2.5 sm:p-3 border border-slate-800 shadow-2xl backdrop-blur-xl">
                {/* Profile Photo */}
                <div className="relative rounded-2xl overflow-hidden aspect-square bg-slate-950">
                  <img
                  ...
                  {/* Top Badge Overlay */}
                  <div className="absolute top-3 right-3 bg-slate-950/80 backdrop-blur-md px-2.5 py-1 rounded-full border border-slate-700/60 text-[11px] sm:text-xs font-medium text-cyan-300 flex items-center gap-1.5 shadow-lg">
                ...
                <div className="flex items-center justify-between gap-1.5 p-2.5 mt-1 bg-slate-950/60 rounded-xl border border-slate-800/80 text-[11px] sm:text-xs font-mono text-slate-400">
        ...
        <div className="mt-12 sm:mt-20 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {PERSONAL_DATA.stats.map((stat, idx) => (
            <div
              key={idx}
              className="glass-card glass-card-hover p-4 sm:p-6 rounded-2xl border border-slate-800 flex flex-col items-center justify-center text-center"
            >
